...
const App: React.FC = () => {
  ...
  const handleExportCSV = () => {
    ...
    link.setAttribute(
      "download",
      `bioscout_leads_${new Date().toISOString().slice(0, 10)}.csv`
    );
  ...
  const getFilterLabel = () => {
    switch (filterMode) {
      case "high":
        return "High Potential (>50)";
      case "ai":
        return "AI Generated Only";
      default:
        return "All Leads";
    }
  };
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">
                  Automated Lead Identification & Ranking
                </p>
              </div>
            </div>
        ...
        {agentStatus === "no-key" && (
          <div className="bg-amber-50 border-b border-amber-200 px-4 py-2">
            <div className="max-w-7xl mx-auto flex items-center text-sm text-amber-800">
              ...
              <span>
                <strong>API Key Not Found:</strong> Real-time data is
                unavailable. Please configure your API_KEY to use this
                application.
              </span>
            </div>
          </div>
        ...
        {agentStatus === "error" && (
          <div className="bg-red-50 border-b border-red-200 px-4 py-2">
            <div className="max-w-7xl mx-auto flex items-center text-sm text-red-800">
              <AlertCircle className="w-4 h-4 mr-2" />
              <span>
                <strong>No Results Found:</strong> The Agent could not find data
                matching your specific query. Try broadening your search terms.
              </span>
            </div>
          </div>
        )}
        {agentStatus === "connected" && (
          <div className="bg-green-50 border-b border-green-200 px-4 py-2">
            <div className="max-w-7xl mx-auto flex items-center text-sm text-green-800">
              ...
              <span>
                <strong>Agent Active:</strong> Retrieving real-time data from
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center mb-4 space-y-2 sm:space-y-0">
              ...
              <div className="flex space-x-2">
                <button
                  ...
                  className={`flex items-center space-x-1 px-3 py-2 border rounded-md text-sm transition-colors ${
                    filterMode !== "all"
          ...
          {isSearching ? (
            <div className="text-center py-20 bg-white rounded-lg border border-dashed border-gray-300 flex flex-col items-center justify-center min-h-[400px]">
              ...
              <p className="text-gray-500 mt-2">
                The agent is analyzing live data sources to find matches.
              </p>
            </div>
            ...
            <div className="text-center py-20 bg-white rounded-lg border border-dashed border-gray-300 min-h-[400px] flex flex-col items-center justify-center">
              {!hasSearched ? (
                <>
                  ...
                  <p className="text-gray-500 mt-2">
                    Enter your search criteria above to find high-value leads.
                  </p>
                </>
              ) : (
                <>
                  ...
                  <p className="text-gray-500 mt-2">
                    No leads, try to be more specific.
                  </p>
                </>
              )}
            </div>
